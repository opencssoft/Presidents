//
//  LangguageListControllerTableViewController.swift
//  Presidents
//
...
class LangguageListControllerTableViewController: UITableViewController {
    weak var detailViewController:DetailViewController? = nil
    private let languageNames:[String] = ["Chinese","Engilish","Frenche","German","Spanish"]
